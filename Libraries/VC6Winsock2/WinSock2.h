...
#endif /* FD_SETSIZE */
#ifndef _DEFINED_FD_SET
#define _DEFINED_FD_SET
typedef struct fd_set {
        u_int fd_count;               /* how many are SET? */
        SOCKET  fd_array[FD_SETSIZE];   /* an array of SOCKETs */
} fd_set;
#endif // _DEFINED_FD_SET
...
#ifndef _DEFINED_FD_SET_MACRO
#define _DEFINED_FD_SET_MACRO
 ...
 */
#ifndef _DEFINED_TIME_VAL
#define _DEFINED_TIME_VAL
struct timeval {
        long    tv_sec;         /* seconds */
        long    tv_usec;        /* and microseconds */
};
#endif //_DEFINED_TIME_VAL
...
#ifndef _DEFINED_HOSTNETENT_
#define _DEFINED_HOSTNETENT_
struct  hostent {
...
//--UBT needed in some builds, depending on build order 
...
//typedef unsigned long * DWORD_PTR, *PDWORD_PTR;		// from <basetsd.h>

// --UBT Note: DWORD_PTR is only used 3 times in this file.  It has been renamed to DWORD_PTRX to resolve a VC6 build conflict with another DWORD_PTR
typedef ULONG_PTR DWORD_PTRX, *PDWORD_PTRX;
 ...
 */
// --UBT mutually exclusive definitions found in <ws2def.h>
 ...
 */
#ifndef _DEFINED_SOCK_ADDR_WSADATA_
#define _DEFINED_SOCK_ADDR_WSADATA_
struct sockaddr_in {
        short   sin_family;
        u_short sin_port;
...
#endif //  _DEFINED_SOCK_ADDR_WSADATA_
 ...
 * addresses.
 */
#ifndef _SOCK_ADDR_DEFINED
#define _SOCK_ADDR_DEFINED
struct sockaddr {
 ...
 */
// --UBT see _UBT_WSABUF_DEFINED_ in <ws2def.h>
...
// --UBT see _UBT_SOCK_ADDR_IN_DEFINED in <ws2def.h>
