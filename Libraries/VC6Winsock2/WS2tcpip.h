// --UBT file dated 2012 from "C:\Program Files (x86)\Windows Kits\8.0\Include\um"
/*
...
//#include<r.we.here> // note: the VC6 compiler cant get here with the previous as as non-comment - there is a workaround for everything, when there is a will there is a way.
