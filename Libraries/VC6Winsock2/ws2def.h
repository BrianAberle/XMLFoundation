...
//
#ifndef UBT_ADDED_SOCKADDR_DEFINED
#define UBT_ADDED_SOCKADDR_DEFINED
...
#endif //UBT_ADDED_SOCKADDR_DEFINED
...
#ifndef UBT_ADDED_SOCKADDR_STORAGE_DEFINED
#define UBT_ADDED_SOCKADDR_STORAGE_DEFINED
...
// --UBT Note: the following code has a prerequisite of a bunch of defines such as
//
...
#else // #if defined(_MSC_VER) && _MSC_VER > 1200		// so this is VC6 and older


// so here is the problem........

// In the VC6 build, values like IPPROTO_ICMP have already been defined, and the compiler doesnt like defining them again in this enum
// but since the values have been defined , these definitions dont matter, and neither do their names so prefix them with UBT.
...
typedef enum {
#if(_WIN32_WINNT >= 0x0501)
    UBT_IPPROTO_HOPOPTS       = 0,  // IPv6 Hop-by-Hop options
#endif//(_WIN32_WINNT >= 0x0501)
    UBT_IPPROTO_ICMP          = 1,
    UBT_IPPROTO_IGMP          = 2,
    UBT_IPPROTO_GGP           = 3,
...
#if(_WIN32_WINNT >= 0x0501)
    UBT_IPPROTO_IPV6          = 41, // IPv6 header
    UBT_IPPROTO_ROUTING       = 43, // IPv6 Routing header
    UBT_IPPROTO_FRAGMENT      = 44, // IPv6 fragmentation header
    UBT_IPPROTO_ESP           = 50, // encapsulating security payload
    UBT_IPPROTO_AH            = 51, // authentication header
    UBT_IPPROTO_ICMPV6        = 58, // ICMPv6
    UBT_IPPROTO_NONE          = 59, // IPv6 no next header
    UBT_IPPROTO_DSTOPTS       = 60, // IPv6 Destination options
#endif//(_WIN32_WINNT >= 0x0501)
...
// --UBT mutually exclusive definitions found in <winsock2.h>
#ifndef _UBT_DEFINED_CLASSABC_
#define  _UBT_DEFINED_CLASSABC_
...
// --UBT see _UBT_SOCK_ADDR_IN_DEFINED in <winsock2.h>
#ifndef _UBT_SOCK_ADDR_IN_DEFINED
#define _UBT_SOCK_ADDR_IN_DEFINED
 ...
 */
// --UBT see _UBT_WSABUF_DEFINED_ in <winsock2.h>
#ifndef _UBT_WSABUF_DEFINED_
#define _UBT_WSABUF_DEFINED_
