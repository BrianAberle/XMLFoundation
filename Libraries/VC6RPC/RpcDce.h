...
//#include <ATL/specstrings.h>  // has definition for  __nullterminated
#include <specstrings.h>  // has definition for  __nullterminated


// --UBT the definition for I_RPC_HANDLE is in rpc.h
...
//#include <rpc.h>  // has definition for  I_RPC_HANDLE, had to be added to this file
//#include <rpcndr.h> 
//#include <winsock2.h> // definition for ULONG_PTR and other basics

// --UBT added preprocessor _RPC_DEFINED_VECTOR_BINDING and copied code to <rpcnsi.h>
#ifndef _RPC_DEFINED_VECTOR_BINDING

	#define _RPC_DEFINED_VECTOR_BINDING


	#ifndef GUID_DEFINED
		#include <ATL/guiddef.h>
	#endif /* GUID_DEFINED */

	#ifndef UUID_DEFINED
		#define UUID_DEFINED

		typedef GUID UUID;//--UBT Globally Unique and Universally Unique, == (G)lobally and (U)niversally in (R)eality (U)nique.  This is My Identidier.
	...
	typedef void * I_RPC_HANDLE; // definied in <rpc.h>
...
//#include <ATL/rpcdcep.h>
#include <rpcdce.h> // because <rpcdcep.h> needs RPC_MGR_EPV
#include <rpcdcep.h>
