...
class MyOrder extends XMLObject
{
    ...
    void MapXMLTagsToMembers()
    {
        ...
        MapMember(vecLI,      "vecLI",          "LineItem",     "gapp/MyLineItem", "LineItemContainer");
        // or we could put the objects into a Hash table as easily as a Vector like this...
		// MapMember(hashLI,	"hashLI",	    "LineItem", 	 "gapp/MyLineItem",     "LineItemContainer");
...
class Customer1 extends XMLObject
{
    ...
    void MapXMLTagsToMembers()
    {
        ...
        // ============================================================
        MapMember(objOrderXXX, "objOrderXXX",  "Order",	   "gapp/MyOrder");
...
class Customer2
{
    ...
    void MyExchange(String inOut)
    {
        ...
        ContainedXMLObj.Member(this, inOut, objOrder,	"objOrder",	"Order","gapp/MyOrder","");
