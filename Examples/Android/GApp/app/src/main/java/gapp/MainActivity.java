...
public class MainActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(gapp.R.layout.activity_main);
        ...
        mViewPager = (ViewPager) findViewById(gapp.R.id.pager);
      ...
      final Runnable r = new Runnable()
        {
            public void run()
            {
                ...
                final ScrollView mScrollView = ((ScrollView) GAppGlobal.tabServer.findViewById(gapp.R.id.scrollView));
                final TextView mText = (TextView) GAppGlobal.tabServer.findViewById(gapp.R.id.editText);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final View rootView = inflater.inflate(gapp.R.layout.fragment_section_server, container, false);

            GAppGlobal.tabServer = rootView;

            mScrollView = ((ScrollView) rootView.findViewById(gapp.R.id.scrollView));
            mText = (TextView) rootView.findViewById(gapp.R.id.editText);
            ...
            // On Clicked Start
            //
            rootView.findViewById(gapp.R.id.start).setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            // On Clicked Stop
            //
            rootView.findViewById(gapp.R.id.stop).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            // On Clicked Clear
            //
            rootView.findViewById(gapp.R.id.clear).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {

                            TextView tv = (TextView) rootView.findViewById(gapp.R.id.editText);
                            tv.setText( "" );
    ...
    public static class ConfigSectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final View rootView = inflater.inflate(gapp.R.layout.fragment_section_config, container, false);
            ...
            // On Clicked Save
            //
            rootView.findViewById(gapp.R.id.save).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    GAppGlobal.messageMe("Saved Config file:");

                    TextView tv = (TextView) rootView.findViewById(gapp.R.id.editConfigFileName);
            ...
            // On Clicked Load
            //
            rootView.findViewById(gapp.R.id.load).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public static class SystemSectionFragment extends Fragment {
        ...
        final Runnable r = new Runnable()
        {
            public void run()
            {
                final ScrollView mScrollView = ((ScrollView) GAppGlobal.tabSystem.findViewById(gapp.R.id.scrollView));
                final TextView mText = (TextView) GAppGlobal.tabSystem.findViewById(gapp.R.id.editText);
...
//                        mScrollView.fullScroll(ScrollView.FOCUS_DOWN);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final View rootView = inflater.inflate(gapp.R.layout.fragment_section_system, container, false);
...
//                    GAppGlobal.messageMe(strFile);
            ...
            // On Clicked Execute
            //
            rootView.findViewById(gapp.R.id.buttonExec).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
...
//                    GAppGlobal.messageMe(strFile);
            ...
            // On Clicked Pids
            //
            rootView.findViewById(gapp.R.id.pids).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            // On Clicked Ports
            //
            rootView.findViewById(gapp.R.id.ports).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public static class XMLSectionFragment extends Fragment {
        ...
        final Runnable r = new Runnable()
        {
            public void run()
            {
                ...
                final ScrollView mScrollView = ((ScrollView) GAppGlobal.tabXML.findViewById(gapp.R.id.scrollView));
                final TextView mText = (TextView) GAppGlobal.tabXML.findViewById(gapp.R.id.editText);
...
//                        mScrollView.fullScroll(ScrollView.FOCUS_DOWN);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final View rootView = inflater.inflate(gapp.R.layout.fragment_section_xml, container, false);
...
*/
            ...
            // On Clicked Two
            //
            rootView.findViewById(gapp.R.id.two).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            // On Clicked delete
            //
            rootView.findViewById(gapp.R.id.three).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            // On Clicked line+
            //
            rootView.findViewById(gapp.R.id.four).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public static class EmailSectionFragment extends Fragment {
        ...
        final Runnable r = new Runnable()
        {
            public void run()
            {
                ...
                final ScrollView mScrollView = ((ScrollView) GAppGlobal.tabEmail.findViewById(gapp.R.id.scrollView));
                final TextView mText = (TextView) GAppGlobal.tabEmail.findViewById(gapp.R.id.editText);

                String st = (String)spinner.getSelectedItem();
                if (st != stLast){
                    stLast = st;
                    EmailSectionFragment.showResults(st);
                    final TextView mValueText = (TextView) GAppGlobal.tabEmail.findViewById(gapp.R.id.editTextValue);
...
//                        mScrollView.fullScroll(ScrollView.FOCUS_DOWN);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final View rootView = inflater.inflate(gapp.R.layout.fragment_section_email, container, false);
            ...
            // On Clicked SetValue
            //
            rootView.findViewById(gapp.R.id.setvalue).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    TextView tv = (TextView) rootView.findViewById(gapp.R.id.editTextValue);
            ...
            // On Clicked ShowAll
            //
            rootView.findViewById(gapp.R.id.showall).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            // On Clicked Send
            //
            rootView.findViewById(gapp.R.id.send).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public static class HTTPSectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            final View rootView = inflater.inflate(gapp.R.layout.fragment_section_http, container, false);
            GAppGlobal.tabHTTP = rootView;

            //
            // On Clicked button1
            //
            rootView.findViewById(gapp.R.id.button1).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            // On Clicked button2
            //
            rootView.findViewById(gapp.R.id.button2).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public static class NextSectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(gapp.R.layout.fragment_section_next, container, false);

            GAppGlobal.tabNext = rootView;

            Bundle args = getArguments();
            ((TextView) rootView.findViewById(android.R.id.text1)).setText(
                    getString(gapp.R.string.next_section_text, args.getInt(ARG_SECTION_NUMBER)));
            return rootView;
        }
    }
